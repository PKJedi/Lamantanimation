...
';
  ...
  waiterProto = {
    ...
    link: function(img, possibilities) {
      ...
      this.check = function() {
        ...
        if (_this.possibilities[_this.pos]) {
          return _this["try"]();
        }
      };
      this["try"] = function() {
  ...
  $(function() {
    var $a, a, ctx, e, editedText, flashPlaying, hostImage, img, key, sendPlayer, support, value, waiter;
    $a = $('audio');
    a = $a[0];
    support = false;
    try {
